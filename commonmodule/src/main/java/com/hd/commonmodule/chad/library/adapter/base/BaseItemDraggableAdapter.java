...
import com.hd.commonmodule.chad.library.adapter.base.listener.OnItemDragListener;
import com.hd.commonmodule.chad.library.adapter.base.listener.OnItemSwipeListener;
...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    /**
     * @param onItemDragListener Register base_spalsh callback to be invoked when drag event happen.
     */
