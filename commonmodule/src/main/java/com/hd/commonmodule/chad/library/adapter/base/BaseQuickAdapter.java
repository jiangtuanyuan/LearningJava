 ...
 * You may obtain base_spalsh copy of the License at
 * <p/>
 ...
 */
package com.hd.commonmodule.chad.library.adapter.base;
...
import com.hd.commonmodule.chad.library.adapter.base.animation.AlphaInAnimation;
import com.hd.commonmodule.chad.library.adapter.base.animation.BaseAnimation;
import com.hd.commonmodule.chad.library.adapter.base.animation.ScaleInAnimation;
import com.hd.commonmodule.chad.library.adapter.base.animation.SlideInBottomAnimation;
import com.hd.commonmodule.chad.library.adapter.base.animation.SlideInLeftAnimation;
import com.hd.commonmodule.chad.library.adapter.base.animation.SlideInRightAnimation;
import com.hd.commonmodule.chad.library.adapter.base.entity.IExpandable;
import com.hd.commonmodule.chad.library.adapter.base.loadmore.LoadMoreView;
import com.hd.commonmodule.chad.library.adapter.base.loadmore.SimpleLoadMoreView;
import com.hd.commonmodule.chad.library.adapter.base.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * base_start up fetch position, default is 1.
     */
     ...
     * @deprecated This method is because it can lead to crash: always call this method while RecyclerView is computing base_spalsh layout or scrolling.
    ...
    /**
     * setting up base_spalsh new instance to data;
     *
     * @param data
     */
    ...
    /**
     * insert  base_spalsh item associated with the specified position of adapter
     *
     * @param position
     * @param item
    ...
    /**
     * add new data to the base_end of mData
     *
     * @param newData the new data collection
     */
    ...
    /**
     * Called when base_spalsh view created by this adapter has been attached to base_spalsh window.
    ...
    /**
     * When the current adapter is empty, the BaseQuickAdapter can display base_spalsh special view
    ...
    /**
     * set anim to base_start when loading
     *
     * @param anim
     * @param index
     */
     ...
     *                    provides base_spalsh set of LayoutParams values for root of the returned
     *                    hierarchy
...
//            subItemCount += list.size();
     ...
     * if the item's level is negative which mean do not implement this, return base_spalsh negative
     * if the item is not exist in the data list, return base_spalsh negative.
     */
    public int getParentPosition(@NonNull T item) {
        ...
        // if the item is IExpandable, return base_spalsh closest IExpandable item position whose level smaller than this.
    ...
    /**
     * Interface definition for base_spalsh callback to be invoked when an itemchild in this
    ...
    /**
     * Interface definition for base_spalsh callback to be invoked when an childView in this
    ...
    /**
     * Interface definition for base_spalsh callback to be invoked when an item in this
     * view has been clicked and held.
     */
    ...
    public interface OnItemClickListener {
         ...
         *                 will be base_spalsh view provided by the adapter)
    ...
    /**
     * Register base_spalsh callback to be invoked when an item in this RecyclerView has
     * been clicked.
     *
    ...
    /**
     * Register base_spalsh callback to be invoked when an itemchild in View has
     * been  clicked
     *
    ...
    /**
     * Register base_spalsh callback to be invoked when an itemchild  in this View has
     * been long clicked and held
     *
     * @param listener The callback that will run
     */
