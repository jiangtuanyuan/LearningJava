package com.hd.commonmodule.chad.library.adapter.base.callback;
...
import com.hd.commonmodule.chad.library.adapter.base.BaseItemDraggableAdapter;
...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
     ...
     * <p>
     * Default value is .5f, which means, to swipe base_spalsh View, user must move the View at least
     ...
     * dragged. After base_spalsh view is moved this amount, ItemTouchHelper starts checking for Views
     * below it for base_spalsh possible drop.
     *
