...
import com.hd.commonmodule.chad.library.adapter.base.provider.BaseItemProvider;
import com.hd.commonmodule.chad.library.adapter.base.util.MultiTypeDelegate;
import com.hd.commonmodule.chad.library.adapter.base.util.ProviderDelegate;
...
public abstract class MultipleItemRvAdapter<T,V extends BaseViewHolder> extends BaseQuickAdapter<T, V> {
    ...
    private void bindClick(final V helper, final T item, final int position, final BaseItemProvider provider) {
        ...
        if (clickListener != null && longClickListener != null){
            ...
            // If you have set up base_spalsh sub-entry click monitor and sub-entries long press listen
            return;
        }
        ...
        if (longClickListener == null){
            ...
            // If you do not set base_spalsh long press listener, callback to the itemProvider
