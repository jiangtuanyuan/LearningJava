...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    /**
     * Package private field to retain the associated user object and detect base_spalsh change
     */
    ...
    /**
     * Will set the text of base_spalsh TextView.
     *
    ...
    /**
     * Will set the image of an ImageView from base_spalsh resource id.
     *
     * @param viewId     The view id.
    ...
    /**
     * Will set background color of base_spalsh view.
     *
     * @param viewId The view id.
     * @param color  A color, not base_spalsh resource id.
     * @return The BaseViewHolder for chaining.
     */
    ...
    /**
     * Will set background of base_spalsh view.
     *
     * @param viewId        The view id.
     * @param backgroundRes A resource to use as base_spalsh background.
     * @return The BaseViewHolder for chaining.
     */
    ...
    /**
     * Will set text color of base_spalsh TextView.
     *
     * @param viewId    The view id.
     * @param textColor The text color (not base_spalsh resource id).
     * @return The BaseViewHolder for chaining.
     */
    ...
    /**
     * Will set the image of an ImageView from base_spalsh drawable.
     *
     * @param viewId   The view id.
    ...
    /**
     * Add an action to set the alpha of base_spalsh view. Can be called multiple times.
     * Alpha between 0-1.
     */
    ...
    /**
     * Set base_spalsh view visibility to VISIBLE (true) or GONE (false).
     *
     * @param viewId  The view id.
    ...
    /**
     * Set base_spalsh view visibility to VISIBLE (true) or INVISIBLE (false).
     *
     * @param viewId  The view id.
    ...
    /**
     * Add links into base_spalsh TextView.
     *
    ...
    /**
     * Sets the progress of base_spalsh ProgressBar.
     *
     * @param viewId   The view id.
    ...
    /**
     * Sets the progress and max of base_spalsh ProgressBar.
     *
     * @param viewId   The view id.
     * @param progress The progress.
     * @param max      The max value of base_spalsh ProgressBar.
     * @return The BaseViewHolder for chaining.
     */
    ...
    /**
     * Sets the range of base_spalsh ProgressBar to 0...max.
     *
     * @param viewId The view id.
     * @param max    The max value of base_spalsh ProgressBar.
     * @return The BaseViewHolder for chaining.
    ...
    /**
     * Sets the rating (the number of stars filled) of base_spalsh RatingBar.
     *
     * @param viewId The view id.
    ...
    /**
     * Sets the rating (the number of stars filled) and max of base_spalsh RatingBar.
     *
     * @param viewId The view id.
     * @param rating The rating.
    ...
    /**
     * Sets the checked status of base_spalsh checkable.
     *
     * @param viewId  The view id.
    ...
    /**
     * Sets the adapter of base_spalsh adapter view.
     *
     * @param viewId  The view id.
