package com.hd.commonmodule.view.step;
...
import com.hd.commonmodule.utils.UIUtils;
...
public class FlowViewHorizontal extends View {
    ...
    private String[] titles = {"待维修", "待复验", "已维修"};
    ...
    public FlowViewHorizontal(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        proColor = ta.getColor(R.styleable.FlowViewHorizontal_h_pro_color, Color.parseColor("#61E2CD"));
        ...
        maxStep = ta.getInt(R.styleable.FlowViewHorizontal_h_max_step, 3);
        textSize = (int) ta.getDimension(R.styleable.FlowViewHorizontal_h_textsize, 14);
...
//        proPaint.setTextSize(UIUtils.dip2Px(textSize));
