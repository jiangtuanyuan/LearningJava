...
public class MapTable {
     ...
     * @param files
     */
    public static void openFile(Context context, String files) {
        File file = null;
        try {
            ...
            intent.setDataAndType(Uri.fromFile(file), getMIMEType(files));//设置类型
            context.startActivity(intent);
        } catch (Exception e) {
            e.printStackTrace();
            ToastUtil.showToast("sorry附件不能打开，请下载相关软件！");
        }
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                Uri contentUri = FileProvider.getUriForFile(context, BuildConfig.APPLICATION_ID + ".root_path", new File(file));
