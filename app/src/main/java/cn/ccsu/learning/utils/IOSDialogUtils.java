...
public class IOSDialogUtils {
    ...
    public void showDialogIOS(Context context, final IOSDialogBean bean) {
        final CustomDialog dialog = new CustomDialog(context, R.layout.ios_dialog);
    ...
    public interface OnButtonClickListener {
        void onPositiveButtonClick(CustomDialog dialog);

        void onCancelButtonClick(CustomDialog dialog);
    }
     ...
     * @param tf
     */
    public static void NoCosleDialog(DialogInterface dialog, boolean tf) {
