 ...
 * 拓展知识
 */
public class JavaFragmentExpand extends JavaBaseFragment implements OnRefreshListener, OnLoadMoreListener, BaseQuickAdapter.OnItemChildClickListener {
    ...
    public static JavaFragmentExpand newInstance(boolean isteacher) {
        Bundle args = new Bundle();
    ...
    public View initSuccessView() {
        View view = LayoutInflater.from(MyApp.getContext()).inflate(R.layout.fragment_java_expand, null, false);
    ...
    public void onViewClicked() {
        showAddListDialog("3", mSmartRefreshLayout);
    }
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        switch (view.getId()) {
            case R.id.iv_delete:
                ...
                break;
            case R.id.ll_layout:
                BasisListActivity.actionStart(getContext(), mSumList.get(position), "3","拓展知识");
                break;
            default:
                break;
        }
