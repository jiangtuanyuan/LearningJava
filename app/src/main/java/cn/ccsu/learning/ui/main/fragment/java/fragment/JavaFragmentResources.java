 ...
 * 相关资源
 */
public class JavaFragmentResources extends JavaBaseFragment implements OnRefreshListener, OnLoadMoreListener, BaseQuickAdapter.OnItemChildClickListener {
    ...
    public static JavaFragmentResources newInstance(boolean isteacher) {
        Bundle args = new Bundle();
    ...
    public View initSuccessView() {
        View view = LayoutInflater.from(MyApp.getContext()).inflate(R.layout.fragment_java_resources, null, false);
    ...
    public void onViewClicked() {
        showAddListDialog("5", mSmartRefreshLayout);
    }
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        switch (view.getId()) {
            case R.id.iv_delete:
                ...
                break;
            case R.id.ll_layout:
                BasisListActivity.actionStart(getContext(), mSumList.get(position), "5", "相关资源");
                break;
            default:
                break;
        }
