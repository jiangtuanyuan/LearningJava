...
public class AddTeacherActivity extends BaseActivity {
    ...
    public static void actionStart(Activity activity, int code) {
        Intent intent = new Intent(activity, AddTeacherActivity.class);
