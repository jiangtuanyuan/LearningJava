 ...
 * 实例教程
 */
public class JavaFragmentInstance extends JavaBaseFragment implements OnRefreshListener, OnLoadMoreListener, BaseQuickAdapter.OnItemChildClickListener {
    ...
    public static JavaFragmentInstance newInstance(boolean isteacher) {
        Bundle args = new Bundle();
    ...
    public View initSuccessView() {
        View view = LayoutInflater.from(MyApp.getContext()).inflate(R.layout.fragment_java_instance, null, false);
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        switch (view.getId()) {
            case R.id.iv_delete:
                ...
                break;
            case R.id.ll_layout:
                BasisListActivity.actionStart(getContext(), mSumList.get(position), "4","实例教程");
                break;
            default:
                break;
        }
